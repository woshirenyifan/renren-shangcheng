  ...
  <div class="content">
    <div class="list-block">
      <ul>
		...
		<div class="item-content">
			...
			<div class="item-inner">
				<label for="j_captcha" class="item-title label">verify</label> 
				<input
					id="j_captcha" name="j_captcha" type="text"
					class="form-control in" placeholder="yanzhengma" />
				<div class="item-input">
					<img id="captcha_img"  title="change"
						onclick="this.src='/yanzhengma?d='+new Date()*1" src="/yanzhengma"/>
				</div>
			</div>
		</div>
	</li>
    ...
    <div class="content-block">
      <div class="row">
        ...
        <div class="col-50"><a href="#" class="button button-big button-fill button-success">commit</a></div>
      </div>
    </div>
  </div>
</div>
